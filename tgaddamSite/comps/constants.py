background = {
        ...
        "background-image":"linear-gradient(to top, #1d3c42, #1e2d37, #1e1e26, #161216, #000000)",
        "width":"100vw",
        "height":"100vh"}
...
heading = {
        ...
        "background-image":"linear-gradient(to right, #cd2a9c, #a73ca7, #7d47a9, #514ca4, #1b4c97)",
...
navbar = {      
        "size":"lg",
        "_hover":{"box-shadow":f"#D434A4 {hoverSize}px {hoverSize}px, #000000 {hoverSize + 1}px {hoverSize + 1}px, #E41581 {hoverSize * 2 + 1}px {hoverSize * 2 + 1}px",},
}